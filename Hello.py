...
SOURCE_BUCKET = _get_optional_arg(sys.argv, 'source_bucket', 'nontrauma-claim-dev')
TARGET_BUCKET = _get_optional_arg(sys.argv, 'target_bucket', 'nontrauma-analytics-dev')
